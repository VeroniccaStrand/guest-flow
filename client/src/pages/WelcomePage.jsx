    ...
    <div className="grid grid-cols-[1.5fr_3.5fr] h-screen bg-bg-image bg-center bg-cover p-10">
      ...
      <div className="flex flex-col  overflow-hidden">
        ...
        <div className='container grid  h-full  items-center'>
          ...
          <div className="grid grid-cols-auto-fill-sm 5xl:grid-cols-auto-fill-100 gap-8 min-h-[600px] mb-4 mt-10 mr-10 relative">
            {todaysVisits.length > 0 ? (
              todaysVisits.map((visit) => {
                ...
                return (
                  ...
                  <div key={visit.id} className=' shadow-2xl  rounded p-4 relative flex flex-col bg-white bg-opacity-50 justify-between'>
                    ...
                    <div className=''>
                      <p className='text-nyans-text text-ms '>{visit.company_info}</p>
                    </div>
